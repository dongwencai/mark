...
nnoremap <silent> J :call <sid>SearchCurrentMark()<cr>
nnoremap <silent> K :call <sid>SearchCurrentMark("b")<cr>
nnoremap <silent> <leader>J :call <sid>SearchAnyMark()<cr>
nnoremap <silent> <leader>K :call <sid>SearchAnyMark("b")<cr>
